...
* total NANI and NAPI
  ...
  * for a watershed or set of watersheds specified by the user
* total fertilizer N and P and fixation N inputs
  * by commodity (crop, ethanol, and animal products)
  * by watershed
* manure N and P production by animal type
* atmospheric N dep by watershed
* county-level
  * human/animal N/P intake
  * crop fertilizer N/P and fixation N inputs
  * detergent P use
  * N/P in animal products
  * N/P in manure
  * crop production (kg and km2)
  * N/P in crops
